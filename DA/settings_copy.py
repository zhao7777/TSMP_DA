...
settings_run={'models': 'eCLM', #model components to include ('eCLM' or 'CLM3.5-PFL', rest to be done..)
              ...
              'dir_setup':'/p/scratch/cjibg36/jibg3674/CLM5_DA/small_test', #folder in which the case will be run
              ...
              'dir_template':'/p/project/cjibg36/jibg3674/shared_DA/setup_eclm_cordex_444x432_v8/', #folder containing all clm/pfl/oasis/namelist files, where everything with 2 underscores (__variable__) needs to be filled out 
